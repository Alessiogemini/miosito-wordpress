...
if ( apply_filters( 'stm_me_get_nuxy_mod', false, 'show_registered' ) ) {
...
if ( apply_filters( 'stm_me_get_nuxy_mod', false, 'show_vin' ) ) {
...
if ( apply_filters( 'stm_me_get_nuxy_mod', false, 'show_history' ) ) {
