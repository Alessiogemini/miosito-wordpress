<?php
$filter_bg = apply_filters( 'stm_me_get_nuxy_mod', get_template_directory_uri() . '/assets/images/listing-directory-filter-bg.jpg', 'sidebar_filter_bg' );
...
$show_sold = apply_filters( 'stm_me_get_nuxy_mod', false, 'show_sold_listings' );
?>
