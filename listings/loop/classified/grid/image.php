...
$show_favorite             = ( apply_filters( 'stm_is_dealer_two', false ) || apply_filters( 'stm_is_aircrafts', false ) ) ? false : apply_filters( 'stm_me_get_nuxy_mod', false, 'enable_favorite_items' );
