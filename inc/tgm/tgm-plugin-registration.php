...
function stm_require_plugins_popup( $return = false ) {
	$stm_importer_ver                      = '5.2.9';
	$stm_motors_extends_ver                = '2.3.1';
	$revslider_ver                         = '6.7.7';
	$js_composer_ver                       = '7.6';
	$stm_vehicles_listing_ver              = '7.2.6';
	$stm_listing_types_ver                 = '1.2.22';
	$stm_motors_car_rental_ver             = '1.8.2';
	$stm_megamenu_ver                      = '2.3.13';
	$stm_motors_equipment_ver              = '1.1.9';
	$ulisting_compare_ver                  = '1.1.6';
	$ulisting_wishlist_ver                 = '1.1.3';
	$subscriptio_ver                       = '3.1.1';
	$stm_woocommerce_motors_auto_parts_ver = '1.1.5';
	$stm_motors_classified_five_ver        = '1.4';
	$stm_motors_classified_six_ver         = '1.0.6';
	$stm_motors_events_ver                 = '1.4.5';
	$stm_motors_review_ver                 = '1.4.7';
	$motors_elementor_widgets              = '1.2.38';
	$motors_wpbakery_widgets               = '1.4.9';
