...
function checkPayPerListings() {
	...
	$pay_per_listing_period = apply_filters( 'stm_me_get_nuxy_mod', '30', 'pay_per_listing_period' );
...
function checkPayFeaturedListings() {
	...
	$pay_per_listing_period = apply_filters( 'stm_me_get_nuxy_mod', '30', 'featured_listing_period' );
