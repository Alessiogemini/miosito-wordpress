...
$show_listing_quote      = apply_filters( 'stm_me_get_nuxy_mod', false, 'show_listing_quote' );
$show_listing_trade      = apply_filters( 'stm_me_get_nuxy_mod', false, 'show_listing_trade' );
$show_listing_calculate  = apply_filters( 'stm_me_get_nuxy_mod', false, 'show_listing_calculate' );
$show_listing_vin        = apply_filters( 'stm_me_get_nuxy_mod', false, 'show_listing_vin' );
