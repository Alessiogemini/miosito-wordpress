			...
			<div class="meta-middle">
				<div class="meta-middle-row heading-font clearfix">
					...
					<?php foreach ( $middle_infos as $middle_info_key => $middle_info ) : ?>
						...
						?>
							<?php
							if ( ! empty( $data_meta ) && ! apply_filters( 'stm_is_listing_price_field', true, $middle_info['slug'] ) ) :
						...
						<?php if ( ! empty( $data_value ) ) : ?>
							...
							<?php if ( ! empty( $data_meta ) && ! apply_filters( 'stm_is_listing_price_field', true, $middle_info['slug'] ) ) : ?>
								<?php $counter++; ?>
					...
					<?php endforeach; ?>
					<?php if ( apply_filters( 'stm_me_get_nuxy_mod', false, 'show_listing_stock' ) ) : ?>
