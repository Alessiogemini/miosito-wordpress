			...
			<div class="modal-content">
				<div class="modal-header modal-header-iconed">
					...
					<h3 class="modal-title" id="myModalLabelCalc">
						<?php esc_html_e( 'Calculate Payment', 'motors' ); ?>
					</h3>
				...
				<div class="modal-body">
					...
					/*Calculator default*/
					$interest                     = apply_filters( 'stm_me_get_nuxy_mod', '', 'default_interest_rate' );
					$period                       = apply_filters( 'stm_me_get_nuxy_mod', '', 'default_month_period' );
					$down_payment                 = apply_filters( 'stm_me_get_nuxy_mod', '', 'default_down_payment' );
					$default_down_payment_type    = apply_filters( 'stm_me_get_nuxy_mod', '', 'default_down_payment_type' );
					$default_down_payment_percent = apply_filters( 'stm_me_get_nuxy_mod', '', 'default_down_payment_percent' );
					...
					<div class="stm_auto_loan_calculator">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<a href="#" class="stm-button button-sm calculate_loan_payment dp-in"><?php esc_html_e( 'Calculate', 'motors' ); ?></a>
					...
					<script type="text/javascript">
						(function ($) {
							...
							$(document).ready(function () {
								...
								var stmPriceDel = "<?php echo esc_js( apply_filters( 'stm_me_get_nuxy_mod', ' ', 'price_delimeter' ) ); ?>";
								var stmCurrencyPos = "<?php echo esc_js( apply_filters( 'stm_me_get_nuxy_mod', 'left', 'price_currency_position' ) ); ?>";
