		...
		<div class="container">
			<div class="row header-row" >
				<div class="col-md-2 col-sm-12 col-xs-12">
					...
					<?php
					if ( wp_is_mobile() ) :
						$compare_page = ( defined( 'ULISTING_VERSION' ) && boolval( apply_filters( 'is_listing', array( 'listing_five', 'listing_six' ) ) ) ) ? \uListing\Classes\StmListingSettings::getPages( 'compare_page' ) : apply_filters( 'stm_me_get_nuxy_mod', 156, 'compare_page' );
						...
						$account_link  = ( defined( 'ULISTING_VERSION' ) && boolval( apply_filters( 'is_listing', array( 'listing_five' ) ) ) ) ? stm_c_f_get_page_url( 'account_page' ) : stm_get_author_link( 'register' );
