...
$sidebar          = apply_filters( 'stm_me_get_nuxy_mod', '1864', 'dealer_sidebar' );
$sidebar_position = apply_filters( 'stm_me_get_nuxy_mod', 'right', 'dealer_sidebar_position' );
					...
					<div class="clearfix">
						...
						<div class="stm-dealer-info <?php echo esc_attr( $inline_list ); ?>">
							...
							<?php if ( ! empty( $user['phone'] ) ) : ?>
								<?php $show_number = apply_filters( 'stm_me_get_nuxy_mod', false, 'stm_show_number' ); ?>
