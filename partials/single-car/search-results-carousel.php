<?php
$show_search_results = apply_filters( 'stm_me_get_nuxy_mod', false, 'show_search_results' );

if ( $show_search_results ) :

	$search_results_full_width = apply_filters( 'stm_me_get_nuxy_mod', false, 'search_results_full_width' );
	...
	if ( $search_results_full_width ) {
		...
		$column_classes[]    = 'col';
		$desktop_items       = apply_filters( 'stm_me_get_nuxy_mod', 4, 'search_results_desktop_items' );
		$tablet_items        = apply_filters( 'stm_me_get_nuxy_mod', 3, 'search_results_tablet_items' );
	} else {
