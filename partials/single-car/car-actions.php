...
// Show car actions.
$show_print_btn        = apply_filters( 'stm_me_get_nuxy_mod', false, 'show_print_btn' );
$show_stock            = apply_filters( 'stm_me_get_nuxy_mod', false, 'show_stock' );
$show_test_drive       = ( ! apply_filters( 'stm_is_magazine', true ) ) ? apply_filters( 'stm_me_get_nuxy_mod', false, 'show_test_drive' ) : false;
...
<div class="single-car-actions">
	<ul class="list-unstyled clearfix">
		<?php if ( apply_filters( 'stm_me_get_nuxy_mod', false, 'show_added_date' ) ) : ?>
