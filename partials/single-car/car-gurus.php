...
$guruStyle  = apply_filters( 'stm_me_get_nuxy_mod', 'STYLE1', 'carguru_style' );
$guruRating = apply_filters( 'stm_me_get_nuxy_mod', 'GREAT_PRICE', 'carguru_min_rating' );
$guruHeight = apply_filters( 'stm_me_get_nuxy_mod', '42', 'carguru_default_height' );
